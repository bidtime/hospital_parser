...
type
  THospitalDetailParser = class(THttpParserBase)
  private
  public
    constructor Create();
...
{ THospitalDetailParser }

constructor THospitalDetailParser.Create();
begin
  inherited create();
  FFileName := 'car-brand-all.txt';
end;

destructor THospitalDetailParser.Destroy;
begin
end;

class function THospitalDetailParser.parserIt(const province: string; const html: string;
  strs: TStrings; const cb: TGetStrProc): string;
